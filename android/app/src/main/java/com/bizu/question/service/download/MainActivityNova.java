...
public class MainActivityNova extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_camara) {
            ...
            Toast.makeText(MainActivityNova.this, "Clicou no menu", Toast.LENGTH_SHORT).show();
            Intent irParaQuestoes = new Intent(MainActivityNova.this, ShowAllQuestions.class);
